...
-- Кнопка у миникарты живёт отдельно от выбора вида: она есть всегда, чтобы
-- меню заданий и настройки были под рукой без захода в интерфейс игры.
--
